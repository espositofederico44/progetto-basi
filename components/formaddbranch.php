  ...
  <div class="d-flex justify-content-center align-items-center mt-5">
    <div class="col-lg-7 col-sm-10 col-xs-12">
      <form method="post" class="border p-4 rounded">
        <div class="container">
          <h2 class="mb-4 text-primary">Aggiungi sede</h2>
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" id="nome" name="nome" class="form-control" placeholder="Sede di Milano" required autofocus>
          </div>
          <div class="form-group mb-3">
            <label for="indirizzo">Indirizzo:<span class="required" aria-required="true">*</span></label>
            <input type="text" class="form-control" id="indirizzo" name="indirizzo" placeholder="Via Dante Alighieri" autofocus required>
          </div>
          <div class="form-group mb-3">
            <label for="cap">CAP:<span class="required" aria-required="true">*</span></label>
            <input required class="form-control" type="text" id="cap" name="cap" pattern="\d{5}">
          </div>
          <div class="form-group mb-3">
            <label for="comune">Comune:<span class="required" aria-required="true">*</span></label>
            <input required class="form-control" type="text" id="comune" name="comune" oninput="searchComune()">
            <input type="hidden" id="comune_id" name="comune_id">
            <div id="comuneList" class="dropdown-menu"></div>
          </div>
          <div class="container d-flex justify-content-center align-items-center">
            <button type="submit" name="addbranch" class="btn btn-primary">Aggiungi Sede</button>
          </div>
        </div>
      </form>
